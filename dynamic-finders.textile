...
+ActiveRecord::Base+ happens to have a +method_missing+ defined that uses a few regular expressions to match the method names for these dynamic finders based on the attribute names of the model you're calling them on.
